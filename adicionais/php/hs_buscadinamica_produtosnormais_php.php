<?php
  ...
  if ($categoria_id==""){
    ...
    $hs_sel_produtos = "SELECT produtos.id, produtos.nome, produtos.produtos_diversos FROM produtos INNER JOIN entradasestoque ON entradasestoque.produtos_id=produtos.id WHERE categorias_id='".$categoria_id."' AND marcas_id='".$marca_id."' AND produtos.produtos_diversos='2'";
